...
async function sendPasswordReset(to, name, resetUrl) {
  ...
  await transporter.sendMail({
    ...
    to,
    subject: "Reset your simplixart Workboard password",
    html: `
      <div style="font-family:sans-serif;max-width:480px;margin:0 auto;padding:24px">
        <h2 style="color:#323338">Password Reset</h2>
        <p>Hi ${name},</p>
        <p>We received a request to reset your simplixart Workboard password. Click the button below — this link expires in <strong>1 hour</strong>.</p>
        ...
        <p style="color:#aaa;font-size:11px">simplixart.com</p>
      </div>
    `,
  });
}
